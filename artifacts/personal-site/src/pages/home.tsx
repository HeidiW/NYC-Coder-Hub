  ...
  return (
    <div className="min-h-screen w-full relative scanlines selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-24 relative z-10 flex flex-col gap-32">
        ...
        {/* ABOUT SECTION */}
        <section className="flex flex-col gap-8" data-testid="about-section">
          <motion.div
          ...
          >
            ...
            <h2 className="text-3xl font-bold font-mono tracking-tight">ABOUT.MD</h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-light text-lg leading-relaxed">
            <motion.p
            ...
            >
              I'm a Technical Solutions Consultant and Solutions Engineer in New York City. I live in the space where complex technical systems meet the people who need to understand them — translating architecture into plain English, and business problems into actual solutions.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              ...
              className="text-muted-foreground"
            >
              I've spent my career making technical things click for the humans on both sides of the table. Whether that's scoping a solution, closing a deal, or untangling why the demo broke five minutes before showtime — I'm the person you want in the room.
            </motion.p>
          </div>
        </section>
